...
from .datasets import ADE20K, CocoCaptions, ImageNet, ImageNet22k, ImageNetPacked, NYU
...
def _parse_dataset_str(dataset_str: str):
    ...
    elif name == "ImageNetPacked":
        class_ = ImageNetPacked
        if "split" in kwargs:
            kwargs["split"] = ImageNetPacked.Split[kwargs["split"]]
