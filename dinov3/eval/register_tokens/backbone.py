...
def _vit_kwargs_from_cfg(cfg):
    ...
    return dict(
        ...
        register_to_register_attention=s.get("register_to_register_attention", False),
        patch_to_patch_attention=s.get("patch_to_patch_attention", True),
        ...
        register_insert_layer=s.get("register_insert_layer", None),
